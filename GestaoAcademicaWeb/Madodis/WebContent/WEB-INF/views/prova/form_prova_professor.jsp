...
<body>
	...
	<jsp:include page="../menu.jsp">
		...
		<div class="container">
			...
			<br>
			<div class="col-mod-4">
				<form:form method="post" action="/madodis/salvarProva2"
					commandName="prova">
					...
					<table class="table table-striped">
						...
						<c:forEach items="${prova.provas}" var="prov" varStatus="loop">
							<form:hidden path="provas[${loop.index}].id" />
							<form:hidden path="provas[${loop.index}].aluno.nome" />
							<form:hidden path="provas[${loop.index}].aluno.sexo" />
							<form:hidden path="provas[${loop.index}].aluno.dataNascimento" />
							<form:hidden path="provas[${loop.index}].aluno.nomePai" />
							<form:hidden path="provas[${loop.index}].aluno.nomeMae" />
							<form:hidden path="provas[${loop.index}].aluno.cpf" />
							<form:hidden path="provas[${loop.index}].aluno.rg" />
							<form:hidden path="provas[${loop.index}].aluno.rgOrgaoExpedidor" />
							<form:hidden path="provas[${loop.index}].aluno.tituloEleitoral" />
							<form:hidden path="provas[${loop.index}].aluno.nacionalidade" />
							<form:hidden path="provas[${loop.index}].aluno.naturalidade" />
							<form:hidden path="provas[${loop.index}].aluno.email"/>
							<form:hidden path="provas[${loop.index}].aluno.senha"/>
							<form:hidden path="provas[${loop.index}].aluno.matricula"/>
							<form:hidden path="provas[${loop.index}].aluno.senha"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.id"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.nomeFantasia"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.nomeEmpresarial"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.cnpj"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.inscricaoEstadual"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.id"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.logradouro"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.numero"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.complemento"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.cep"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.bairro"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.cidade"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.endereco.estado"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.telefone.DDD"/>
							<form:hidden path="provas[${loop.index}].aluno.instituicao.telefone.numero"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.id"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.logradouro"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.numero"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.complemento"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.cep"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.bairro"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.cidade"/>
							<form:hidden path="provas[${loop.index}].aluno.endereco.estado"/>
							<form:hidden path="provas[${loop.index}].aluno.telefone.DDD"/>
							<form:hidden path="provas[${loop.index}].aluno.telefone.numero"/>
							<tr>
								<td>${prov.aluno.nome}</td>
								<td>${prova.aula.assunto}</td>
								<td>
									<form:input path="provas[${loop.index}].nota" cssClass="form-control" />
									<form:errors path="provas[${loop.index}].nota" cssClass="error"></form:errors>
								</td>
							</tr>
						</c:forEach>
					</table>
		...
		<script>
			jQuery(document).ready(function() {
				jQuery('.form-control').mask('00.0', {reverse: true});
			});
		</script>
