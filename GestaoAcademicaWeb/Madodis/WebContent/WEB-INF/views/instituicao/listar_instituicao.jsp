...
<title>Madodis - Listar Instituições</title>
...
<body>
	...
	<div class="container">
		<h3>
			<legend>
				<a href="/madodis/inicio">Instituição Cadastrada</a>
			</legend>
		</h3>
	</div>
	...
	<c:if test="${empty instituicaoList}">
		<div class="container">
			<div class="col-mod-4">
				<h4>Não existe registro de instituições cadastradas para mostrar!</h4>
			</div>
		</div>
	</c:if>
