...
<title>Madodis - Cadastrar/Alterar Docentes</title>
			...
			<h3>
				<c:choose>
					<c:when test="${professor.id < 1}">
						<legend>Cadastrar Docente</legend>
					</c:when>
					<c:otherwise>
						<legend>Atualizar Docente</legend>
					</c:otherwise>
				</c:choose>
			</h3>
		</div>
				...
				<form:form method="${my_method}" action="${my_action}"
					...
					<legend>Dados Pessoais</legend>
						...
						<div class="col-sm-6">
							...
							<form:select cssClass="form-control" path="titulacao">
