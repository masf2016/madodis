...
<title>Madodis - Listar Secretaria</title>
...
<body>
	...
	<div class="container">
		<h3>
			<legend>
				<a href="javascript:void(0)">Secretaria Cadastrada</a>
			</legend>
		</h3>
	</div>
	<c:if test="${empty secretariaList}">
		<div class="container">
			<div class="col-mod-4">
				<h4>Não existe registro de secretaria para mostrar!</h4>
			</div>
		</div>
	</c:if>
	<div class="container">
			...
			<table class="table table-striped">
				...
				<c:forEach items="${secretariaList}" var="secretaria">
					<tr>
						...
						<td><a href="javascript:void(0)" onclick="removerSecretaria(${secretaria.id})"><span
		...
		<div>
			<a href="/madodis/form_secretarias"><button
	...
	<script>
			function removerSecretaria(id) {
				$.jAlert({
			        'title': 'Remover',
			        'content': 'Voce deseja remover a secretaria?',
			        'theme': 'blue',
			        'btns': [
			        			{ 
			        				'text': 'Sim', 
			        				'onClick' : function(e, btn) {
			        					$.get("/madodis/remover/secretaria/" + id, function(data) {
			        						document.open();
			        						document.write(data);
			        						document.close();
			        					});
