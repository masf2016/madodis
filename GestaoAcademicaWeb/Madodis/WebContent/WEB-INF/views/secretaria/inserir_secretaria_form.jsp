...
<title>Madodis - Cadastrar/Alterar Secretaria</title>
...
<body>
	...
	<div class="container">
		...
		<div class="col-mod-4">
			...
			<c:choose>
				<c:when test="${secretaria.id < 1}">
					<c:set var="my_action" value="/madodis/adicionarSecretaria" />
				</c:when>
				<c:otherwise>
					<c:set var="my_action" value="/madodis/atualizarSecretaria" />
				</c:otherwise>
			</c:choose>
			...
			<form:form method="post" action="${my_action}"
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<form:input type="date" path="ctpsDataExpedicao"
				...
				<fieldset>
					...
					<div class="col-sm-6">
						...
						<form:select cssClass="form-control" path="instituicao">
							<form:options items="${instituicoes}" itemLabel="nomeFantasia"
								itemValue="id" />
						</form:select>
					</div>
					<div class="col-sm-6">
				...
				<fieldset>
					...
					<div class="col-sm-6">
						<label>Número:</label>
						<form:input id="numero" path="endereco.numero"
				...
				<fieldset>
					...
					<div class="col-sm-6">
						...
						<form:input id="telefone" path="telefone.numero"
							cssClass="form-control" />
