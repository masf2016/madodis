...
<title>Madodis - Cadastrar/Alterar Discentes</title>
...
<body>
		...
		<h3>
			<c:choose>
				<c:when test="${aluno.id < 1}">
					<legend>Cadastrar Discente</legend>
				</c:when>
				<c:otherwise>
					<legend>Atualizar Discente</legend>
				</c:otherwise>
			</c:choose>
		</h3>
	</div>
	<div class="container">
		<div class="col-mod-4"></div>
			...
			<form:form method="post" action="${my_action}" commandName="aluno">
				<form:hidden path="id" />
