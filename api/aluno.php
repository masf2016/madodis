...
$app->post('/aluno', function ($request, $response) {
    ...
    $query = 'INSERT INTO alunos (nome, sexo, datanascim, nomepai, nomemae, cpf, rg, rgorgaoexped, tituloeleitoral, nacionalidade, naturalidade, email, matricula, comprovconclusao) VALUES (:nome, :sexo, :datanascim, :nomepai, :nomemae, :cpf, :rg, :rgorgaoexped, :tituloeleitoral, :nacionalidade, :naturalidade, :email, :matricula, :comprovconclusao)';
    try {
        $db = getConnection();
        $stmt = $db->prepare($query);
...
$app->put('/aluno/{id}', function ($request, $response, $arguments) {
    ...
    $query = 'UPDATE alunos SET nome=:nome, sexo=:sexo, datanascim=:datanascim, nomepai=:nomepai, nomemae=:nomemae, cpf=:cpf, rg=:rg, rgorgaoexped=:rgorgaoexped, tituloeleitoral=:tituloeleitoral, nacionalidade=:nacionalidade, naturalidade=:naturalidade, email=:email, matricula=:matricula, comprovconclusao=:comprovconclusao WHERE id=:id';
    try {
        $db = getConnection();
        $stmt = $db->prepare($query);
