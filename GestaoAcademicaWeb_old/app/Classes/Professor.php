...
private $id_endereco;
private $id_telefone;
public function __construct($id_professor = 0,$nome= "" ,$sexo= "" ,
                            $datanascim = "0000-00-00 00:00:00",
                            $nomepai= "" ,$nomemae= "" ,$cpf= "" ,$rg= "" ,
                            $rgorgaoexped= "" ,$tituloeleitoral= "" ,
                            $nacionalidade= "" ,$naturalidade= "" ,$email= "" ,
                            $matricula= "" ,$ctpsnumero= "" ,
                            $ctpsdataexped = "0000-00-00 00:00:00",$titulacao= "" ,
...
$obj->setTitulacao( $array['titulacao']);
...
public function toString(){
 ...
 return "  [id_professor:" .$this->id_professor. "]  [nome:" .$this->nome. "]
           ...
           [titulacao:" .$this->titulacao. "]  [id_login:" .$this->id_login. "]
